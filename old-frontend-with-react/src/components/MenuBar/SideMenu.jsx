      ...
      <div className="h-full bg-secondary">
        ...
        <div>
          ...
          <div className="flex lg:bg-gray-200 md:bg-gray-200 rounded-lg justify-center py-3 mb-12 px-2 mx-auto mt-6 lg:w-36 md:w-36 gap-2 relative group">
            ...
            <Link to='/schedule'>
            <div className="lg:p-3 md:p-3 rounded-full flex justify-center items-center lg:bg-secondary md:bg-secondary bg-gray-200 lg:text-gray-100 md:text-gray-100 text-secondary">
              <FaPlus size={14} />
            </div>
            </Link>
